...
namespace PeterO.Numbers {
    /// <summary>
    /// Implements the simplified arithmetic in Appendix A of the
    ...
    /// within the <c>exp</c> operation.
    /// </summary>
    /// <typeparam name='T'>Data type for a numeric value in a particular radix.</typeparam>
